...
const plans = [
    {
        ...
        yearlyPrice: 0,
        features: [
            { text: '50 tracked emails/month', included: true },
            { text: 'Open & click tracking', included: true },
            { text: 'Basic dashboard', included: true },
            { text: 'Email sequences (1 active)', included: true },
            { text: 'Email support', included: true },
            { text: 'Advanced analytics', included: false },
            { text: 'Real-time notifications', included: false },
            { text: 'AI email optimization', included: false },
    ...
    },
    {
        ...
        features: [
            ...
            { text: 'AI-powered email optimization', included: true },
            { text: 'Deliverability checker', included: true },
            { text: 'Email sequences', included: true },
            { text: 'Remove MailTrackr branding', included: true },
